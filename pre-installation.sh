...
# Install i3wm
pacman -S vim xorg sway weston xterm xterm xorg-server xorg-apps noto-fonts xf86-input-libinput xf86-video-amdgpu xf86-video-vesa xf86-video-vmware xf86-video-fbdev xf86-video-intel git
